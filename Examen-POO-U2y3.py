...
def crear_pokemon_enemigo(nombre, descripcion, vida, ataque, defensa, nivel, ataque_especial):
    class Enemigo(PokemonConEntrenamiento):
        def __init__(self, nombre, descripcion, vida, nivel, ataque, defensa, ataque_especial):
    ...
    return Enemigo(nombre, descripcion, vida, nivel, ataque, defensa, ataque_especial)
    ...
    while pokemon_jugador.vida > 0 and enemigo.vida > 0:
        ...
        if opcion == "1":
            ...
            if danio >= enemigo.defensa:
                ...
                if enemigo.vida < 0:
                    enemigo.vida = 0
                print(f"\n¡Atacaste! Causaste {danio} de daño")
            else:
